...
HD_PWD='/mnt/500GB/home/steve/TCN/ultra/ultra/ultra.runs/ultra_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_clk_wiz_0_0.tcl
