...
HD_PWD='/mnt/500GB/home/steve/TCN/ultra/ultra/ultra.runs/ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_ps_e_0_0.tcl
