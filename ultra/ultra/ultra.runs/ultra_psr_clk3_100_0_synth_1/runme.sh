...
HD_PWD='/mnt/500GB/home/steve/TCN/ultra/ultra/ultra.runs/ultra_psr_clk3_100_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultra_psr_clk3_100_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultra_psr_clk3_100_0.tcl
